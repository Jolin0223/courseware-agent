...
const styles: Record<string, React.CSSProperties> = {
  shell: {
    ...
    boxShadow: '0 22px 60px var(--agent-shadow), inset 0 1px 0 rgba(255,255,255,0.9)',
    overflow: 'hidden',
  },
  header: {
    position: 'relative',
  ...
  cardSelected: {
    borderColor: 'var(--agent-primary)',
    boxShadow: '0 14px 32px var(--agent-focus-ring-strong)',
  },
  cardHeader: {
    display: 'flex',
    justifyContent: 'space-between',
  ...
  detailPanel: {
    ...
    borderRadius: 14,
    border: '1px solid var(--agent-border)',
    background: 'linear-gradient(135deg, #FFFFFF, var(--agent-soft))',
    boxShadow: '0 12px 28px var(--agent-shadow)',
  },
  cardActions: {
    display: 'flex',
    alignItems: 'center',
