...
import { Music, Play, Pause, CheckCircle2, Loader2, ChevronDown, ChevronUp } from 'lucide-react';
...
const AudioGenerationPanel: React.FC<AudioGenerationPanelProps> = ({ stage, isExpanded, onToggle }) => {
