...
const expandedLauncherWidth = 132;
      ...
      {open && (
        <>
          ...
          >
            ...
            />
            {isDraggingFiles && <div style={styles.dragUploadMask}>松开即可添加到灵感龙虾</div>}
            <div style={styles.header} onMouseDown={event => startFloatingDrag(event, 'panel')}>
              <div style={styles.headerLeft}>
                ...
                <div>
                  <div style={styles.title}>灵感龙虾</div>
              ...
              <div style={styles.headerActions} data-assistant-no-drag="true">
                <button type="button" style={styles.closeBtn} onClick={collapseAssistant} aria-label="最小化灵感龙虾">
