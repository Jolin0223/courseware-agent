...
import { Image as ImageIcon, Upload, RotateCcw, CheckCircle2, Loader2, ChevronDown, ChevronUp, X } from 'lucide-react';
...
const ImageGenerationPanelV2: React.FC<ImageGenerationPanelV2Props> = ({ stage, isExpanded, onToggle }) => {
          ...
          {stage.status !== 'pending' && (
            <div style={{ height: 4, background: '#F1F5F9', borderRadius: 2, marginBottom: 12 }}>
              <div style={{
                ...
                background: stage.status === 'completed' ? '#00C9A7' : 'linear-gradient(90deg, #00C9A7, #00A8E8)',
