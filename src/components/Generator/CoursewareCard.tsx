...
// 模拟资源数据
const MOCK_IMAGES = [
  { id: 'img-1', label: '主界面背景', src: '/images/background.png', prompt: '色彩鲜艳的游戏主界面背景', status: 'completed' as const },
  { id: 'img-2', label: '动物角色', src: '/images/animal.png', prompt: '可爱的卡通小熊角色', status: 'completed' as const },
  { id: 'img-3', label: '奖励星星', src: '/images/star.png', prompt: '金色五角星', status: 'completed' as const },
];

const MOCK_AUDIOS = [
  { id: 'audio-1', label: '单词发音 - Apple', type: 'tts' as const, status: 'completed' as const, voiceId: 'female-1', duration: 1.2 },
  { id: 'audio-2', label: '单词发音 - Banana', type: 'tts' as const, status: 'completed' as const, voiceId: 'female-1', duration: 1.5 },
  { id: 'audio-3', label: '游戏背景音乐', type: 'bgm' as const, status: 'completed' as const, duration: 30.0 },
];
