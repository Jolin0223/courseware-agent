...
const styles: Record<string, React.CSSProperties> = {
  ...
  tabs: {
    ...
    background: 'linear-gradient(180deg, #FFFFFF 0%, var(--agent-soft) 100%)',
  ...
  tabHover: {
    ...
    boxShadow: 'inset 0 0 0 1px var(--agent-border)',
  },
  tabActive: {
    background: '#FFFFFF',
    color: 'var(--agent-primary-text)',
    boxShadow: '0 7px 18px var(--agent-focus-ring-strong), inset 0 0 0 1px var(--agent-border)',
  },
  emptyState: {
    textAlign: 'center',
    padding: '86px 20px',
  ...
  draftFilterTagHover: {
    ...
    color: 'var(--agent-primary-text)',
    boxShadow: '0 4px 10px var(--agent-focus-ring)',
  },
